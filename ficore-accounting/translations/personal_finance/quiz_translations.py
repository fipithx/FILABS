...
QUIZ_TRANSLATIONS = {
    'en': {
        ...
        'quiz_saver': 'Saver',
            ...
            'quiz_quiz_saver_description': 'You are a cautious saver, prioritizing financial security.',
            'quiz_score_breakdown': 'Score Breakdown',
            'quiz_comparison': 'Comparison with Others',
            'quiz_rank': 'Your Rank',
            'quiz_average_score': 'Average Score',
            'badge_first_quiz_taker': 'First Quiz Taker',
            'badge_first_quiz_taker_desc': 'Awarded for completing your first financial quiz.',
            'quiz_previous_assessments': 'Previous Assessments',
            'quiz_personality': 'Financial Personality',
        ...
        'financial_personality_quiz_title': 'Financial Personality Quiz',
            ...
            'quiz_personal_info': 'Personal Information',
            'quiz_send_email': 'Send Email',
            'quiz_questions': 'Quiz Questions',
            'quiz_progress_bar': 'Progress Bar',
            'quiz_progress_percentage': 'Progress Percentage',
            'quiz_no_results': 'No Results Available',
            'quiz_complete_quiz': 'Complete Quiz',
            'quiz_all_questions_required': 'All Questions Required',
    ...
    'ha': {
        ...
        'quiz_log_error': 'Kuskuren Log na Tambaya',
            'quiz_title': 'Taken Tambaya',
            'quiz_discover_personality': 'Gano Halinka',
            'quiz_results': 'Sakamakon Tambaya',
            'quiz_personal_info': 'Bayanan Kai',
            'quiz_send_email': 'Aika Imel',
            'quiz_questions': 'Tambayoyin Tambaya',
            'quiz_progress_bar': 'Barin Ci Gaba',
        'financial_personality_quiz_title': 'Tambayar Halin Kuɗi',
        ...
        'quiz_saver': 'Mai Tara Kuɗi',
            'quiz_completed_successfully': 'An Kammala Tambayoyin Cikin Nasara',
            'quiz_quiz_saver_description': 'Kai mai tara kuɗi ne mai hankali, kana fifita tsaron kuɗi.',
            'quiz_score_breakdown': 'Rarraba Maki',
